...
def get_auth_setting_by_name(name: str) -> Dict | None:
    return get_db().get_auth_setting_by_name(name)


def get_auth_settings_by_category(category: str) -> List[Dict]:
    return get_db().get_auth_settings_by_category(category)


def upsert_auth_setting_by_name(payload: Setting) -> Dict | None:
    return get_db().upsert_auth_setting_by_name(payload)
